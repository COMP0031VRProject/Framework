...
v_mesh.load("./data_analytics/mesh/reverse_lattice_crush_virtual.json")
v_mesh.verts = [np.array(v) for v in v_mesh.verts]

r_mesh = Mesh(None, None)
r_mesh.load("./data_analytics/mesh/reverse_lattice_crush_real.json")
...
plt.savefig('./data_analytics/figures/reverse_lattice_crush_meshes', bbox_inches = 'tight')
plt.show()
